...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Crear Nuevo Piloto</h1>
            </div>
            <div class="col-sm-6">
            ...
            <form action="{{ route('admin.pilots.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                @error('birth_date')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                                <small class="form-text text-muted">La edad se calculará automáticamente si no se especifica</small>
                            </div>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Crear Piloto
                    </button>
